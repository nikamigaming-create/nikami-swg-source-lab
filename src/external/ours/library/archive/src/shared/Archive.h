...
inline void get(ReadIterator & source, unsigned __int64 & target)
{
	source.get(&target, 8);
}
...
inline void get(ReadIterator & source, signed __int64 & target)
{
	source.get(&target, 8);
}
...
inline void put(ByteStream & target, const unsigned __int64 & source)
{
	target.put(&source, 8);
}
...
inline void put(ByteStream & target, const signed __int64 & source)
{
	target.put(&source, 8);
}
