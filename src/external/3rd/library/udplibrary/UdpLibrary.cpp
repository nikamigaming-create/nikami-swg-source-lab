...
#define WIN32 1
#endif
#if defined(_WIN32) && !defined(UDPLIBRARY_WINSOCK2)
#define UDPLIBRARY_WINSOCK2 1
#endif
...
#include "UdpLibrary.hpp"
	...
	#ifndef _WINSOCKAPI_
	#define _WINSOCKAPI_  // prevent winsock.h from being included if already have winsock2
	#endif
	#if defined(UDPLIBRARY_WINSOCK2) || defined(_WIN64)
		#include <winsock2.h>
		#include <ws2tcpip.h>
	#else
		#include <winsock.h>
