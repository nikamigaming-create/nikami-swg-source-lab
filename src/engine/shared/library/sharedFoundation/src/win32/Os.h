...
public:
	...
	typedef void (*QueueMouseButtonHookFunction)(int mouse, int mouseButton);
	typedef void (*SetSystemMouseCursorPositionHookFunction)(int x, int y);
	typedef bool (*GetHardwareMouseCursorEnabled)();
	typedef void (*QueueVrControllerInputHookFunction)(float leftX, float leftY, bool leftActive, float rightX, float rightY, bool rightActive, float headYawRadians, bool headYawValid, float leftHandYawRadians, bool leftHandYawValid, float rightHandYawRadians, bool rightHandYawValid, bool turnModeClickPressed);
	typedef void (*QueueVrMenuInputHookFunction)(bool pressed);
...
public:
	...
	static void                setQueueMouseButtonDownHookFunction(QueueMouseButtonHookFunction queueMouseButtonHookFunction);
	static void                setQueueMouseButtonUpHookFunction(QueueMouseButtonHookFunction queueMouseButtonHookFunction);
	...
	static void                setQueueVrControllerInputHookFunction(QueueVrControllerInputHookFunction queueVrControllerInputHookFunction);
	static void                setQueueVrMenuInputHookFunction(QueueVrMenuInputHookFunction queueVrMenuInputHookFunction);
	...
	static void                queueVrControllerInput(float leftX, float leftY, bool leftActive, float rightX, float rightY, bool rightActive, float headYawRadians, bool headYawValid, float leftHandYawRadians, bool leftHandYawValid, float rightHandYawRadians, bool rightHandYawValid, bool turnModeClickPressed);
	static void                queueVrMenuInput(bool pressed);
