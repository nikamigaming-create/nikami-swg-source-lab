...
private:
	...
	void        copyOptionListIntersection (const OptionList & src);
	void        clearSavedLists ();
	void        addRegisteredOption (Option const & option);
...
private:
	...
	enum
	{
		cms_maxRegisteredOptions = 4096
	};

	Option m_fixedRegisteredOptions[cms_maxRegisteredOptions];
	int    m_fixedRegisteredOptionCount;
};
