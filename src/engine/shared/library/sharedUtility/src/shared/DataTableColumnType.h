...
struct DataTableColumnTypeEnumEntry
{
	char *label;
	int value;
};

struct DataTableColumnTypeEnumMap
{
	DataTableColumnTypeEnumEntry *entries;
	int count;
	int capacity;
};
...
private:
	...
	typedef DataTableColumnTypeEnumMap StringIntMap;
