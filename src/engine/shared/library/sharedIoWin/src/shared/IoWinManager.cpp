...
void IoWinManager::install()
{
	...
	Os::setQueueMouseButtonDownHookFunction(queueMouseButtonDown);
	Os::setQueueMouseButtonUpHookFunction(queueMouseButtonUp);
...
void IoWinManager::remove(void)
{
	...
	Os::setQueueMouseButtonDownHookFunction(NULL);
	Os::setQueueMouseButtonUpHookFunction(NULL);
