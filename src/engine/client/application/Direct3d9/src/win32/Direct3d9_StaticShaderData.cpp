...
bool Direct3d9_StaticShaderData::Stage::getTextureSortKey(uintptr_t &value) const
{
	if (m_texture)
	{
		value = reinterpret_cast<uintptr_t>((*m_texture)->getBaseTexture());
		return true;
	}
...
bool Direct3d9_StaticShaderData::Pass::getTextureSortKey(uintptr_t &value) const
{
...
bool Direct3d9_StaticShaderData::Pass::apply() const
{
...
#endif
			Direct3d9::setActiveMaterialForInventory(ms_defaultMaterial.material);
		}
		else
#endif
		{
...
#endif
			Direct3d9::setActiveMaterialForInventory(m_material.material);
		}
...
#endif
		Direct3d9::setActiveMaterialForInventory(ms_debugMaterial.material);
	}
#endif
	...
	if (m_textureFactorValid)
	{
		...
		Direct3d9::setActiveTextureFactorForInventory(m_textureFactorData, 2);
#else
#ifdef FFP
		Direct3d9::setActiveTextureFactorForInventory(m_textureFactor);
#endif
#endif
	}
#if DEBUG_LEVEL == DEBUG_LEVEL_DEBUG
	else
	{
		...
		Direct3d9::setActiveTextureFactorForInventory(ms_debugTextureFactorData, 2);
#endif
	}
#endif
...
uintptr_t Direct3d9_StaticShaderData::getTextureSortKey() const
{
