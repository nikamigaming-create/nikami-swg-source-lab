...
namespace Direct3d9_ShaderImplementationDataNamespace
{
	...
	int                                        ms_activePass = -1;
	char const                                *ms_activePixelProgramName = "<null>";
	DWORD                                      ms_activeAlphaBlendSource = D3DBLEND_ONE;
	DWORD                                      ms_activeAlphaBlendDestination = D3DBLEND_ZERO;
	DWORD                                      ms_activeAlphaBlendOperation = D3DBLENDOP_ADD;
	DWORD                                      ms_activeAlphaTestEnable = FALSE;
	DWORD                                      ms_activeAlphaTestFunction = D3DCMP_ALWAYS;
	DWORD                                      ms_activeZEnable = TRUE;
	DWORD                                      ms_activeZWrite = TRUE;
}
...
:
	...
	m_alphaBlendSource(D3DBLEND_ONE),
	m_alphaBlendDestination(D3DBLEND_ZERO),
	m_alphaBlendOperation(D3DBLENDOP_ADD),
	m_alphaTestEnable(FALSE),
	m_alphaTestFunction(D3DCMP_ALWAYS),
	m_zEnable(TRUE),
	m_zWrite(TRUE),
	m_pixelProgramName("<null>"),
	m_renderState()
#ifdef VSPS
#if PRODUCTION == 0
...
void Direct3d9_ShaderImplementationData::Pass::construct(const ShaderImplementation::Pass &pass)
{
	...
	m_alphaBlendOperation = BlendOperation[pass.m_alphaBlendOperation];
	m_alphaBlendSource = Blend[pass.m_alphaBlendSource];
	m_alphaBlendDestination = Blend[pass.m_alphaBlendDestination];
	m_alphaTestEnable = pass.m_alphaTestEnable ? TRUE : FALSE;
	m_alphaTestFunction = Compare[pass.m_alphaTestFunction];
	m_zEnable = pass.m_zEnable ? TRUE : FALSE;
	m_zWrite = pass.m_zWrite ? TRUE : FALSE;
...
#undef RSV
...
#endif
	{
		...
		m_pixelProgramName = pass.m_pixelShader->m_program ? pass.m_pixelShader->m_program->getFileName() : "<null>";
#else
...
{
	ms_activeAlphaBlendSource = m_alphaBlendSource;
	ms_activeAlphaBlendDestination = m_alphaBlendDestination;
	ms_activeAlphaBlendOperation = m_alphaBlendOperation;
	ms_activeAlphaTestEnable = m_alphaTestEnable;
	ms_activeAlphaTestFunction = m_alphaTestFunction;
	ms_activeZEnable = m_zEnable;
	ms_activeZWrite = m_zWrite;
	ms_activePixelProgramName = m_pixelProgramName ? m_pixelProgramName : "<null>";
...
void Direct3d9_ShaderImplementationData::lostDevice()
{
	...
	ms_activePass = -1;
	ms_activePixelProgramName = "<null>";
}

char const *Direct3d9_ShaderImplementationData::getActivePixelProgramName()
{
	return ms_activePixelProgramName ? ms_activePixelProgramName : "<null>";
}

DWORD Direct3d9_ShaderImplementationData::getActiveAlphaBlendSource()
{
	return ms_activeAlphaBlendSource;
}

DWORD Direct3d9_ShaderImplementationData::getActiveAlphaBlendDestination()
{
	return ms_activeAlphaBlendDestination;
}

DWORD Direct3d9_ShaderImplementationData::getActiveAlphaBlendOperation()
{
	return ms_activeAlphaBlendOperation;
}

DWORD Direct3d9_ShaderImplementationData::getActiveAlphaTestEnable()
{
	return ms_activeAlphaTestEnable;
}

DWORD Direct3d9_ShaderImplementationData::getActiveAlphaTestFunction()
{
	return ms_activeAlphaTestFunction;
}

DWORD Direct3d9_ShaderImplementationData::getActiveZEnable()
{
	return ms_activeZEnable;
}

DWORD Direct3d9_ShaderImplementationData::getActiveZWrite()
{
	return ms_activeZWrite;
}
