...
public:
	...
	static char const *getActivePixelProgramName();
	static DWORD getActiveAlphaBlendSource();
	static DWORD getActiveAlphaBlendDestination();
	static DWORD getActiveAlphaBlendOperation();
	static DWORD getActiveAlphaTestEnable();
	static DWORD getActiveAlphaTestFunction();
	static DWORD getActiveZEnable();
	static DWORD getActiveZWrite();
...
public:
	...
	public:
		...
		DWORD                  m_alphaBlendSource;
		DWORD                  m_alphaBlendDestination;
		DWORD                  m_alphaBlendOperation;
		DWORD                  m_alphaTestEnable;
		DWORD                  m_alphaTestFunction;
		DWORD                  m_zEnable;
		DWORD                  m_zWrite;
		char const            *m_pixelProgramName;
