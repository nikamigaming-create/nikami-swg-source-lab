...
public:
	...
	static void                 setActiveFogColor(DWORD color);
	static void                 setActiveFogMode(int fogMode);
	...
	static void                 setActiveMaterialForInventory(D3DMATERIAL9 const &material);
	static void                 setActiveTextureFactorForInventory(DWORD textureFactor);
	static void                 setActiveTextureFactorForInventory(VectorRgba const *textureFactors, int count);
