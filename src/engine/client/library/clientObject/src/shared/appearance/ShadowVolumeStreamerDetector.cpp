...
bool ShadowVolumeStreamerDetector::detectAndReport ()
{
	bool foundPotentialStreamer = false;

	{
		...
		for (int i = 0; i < numberOfFaces; ++i)
		{
			...
			foundPotentialStreamer = addEdge (i0, i1) || foundPotentialStreamer;
			foundPotentialStreamer = addEdge (i1, i2) || foundPotentialStreamer;
			foundPotentialStreamer = addEdge (i2, i0) || foundPotentialStreamer;
		}
	}
...
bool ShadowVolumeStreamerDetector::addEdge (int const i0, int const i1)
{
	if (i0 == i1)
	{
#ifdef _DEBUG
