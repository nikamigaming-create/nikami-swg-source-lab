...
uintptr_t ViewerLightAppearance::LocalShaderPrimitiveParallel::getVertexBufferSortKey() const
{
...
uintptr_t ViewerLightAppearance::LocalShaderPrimitivePoint::getVertexBufferSortKey() const
{
	return m_vertexBuffer.getSortKey ();
}
...
uintptr_t ViewerLightAppearance::LocalShaderPrimitiveSpot::getVertexBufferSortKey() const
{
	return m_vertexBuffer.getSortKey ();
}
