...
public:
	...
	virtual uintptr_t           getVertexBufferSortKey() const;
...
uintptr_t ProxyLocalShaderPrimitive::getVertexBufferSortKey () const
{
	return 0;
}
...
uintptr_t ShadowVolume::LocalShaderPrimitiveRenderEdgesOneSided::getVertexBufferSortKey () const
{
	return 0;
}
...
uintptr_t ShadowVolume::LocalShaderPrimitiveRenderCapsOneSided::getVertexBufferSortKey() const
{
	return 0;
}
...
uintptr_t ShadowVolume::LocalShaderPrimitiveRenderEdgesTwoSided::getVertexBufferSortKey () const
{
	return 0;
}
...
uintptr_t ShadowVolume::LocalShaderPrimitiveRenderCapsTwoSided::getVertexBufferSortKey() const
{
	return 0;
}
