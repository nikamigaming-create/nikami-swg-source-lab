...
uintptr_t ClientLocalWaterManager::LocalShaderPrimitiveDefault::getVertexBufferSortKey() const
{
...
uintptr_t ClientLocalWaterManager::LocalShaderPrimitiveRibbonStrip::getVertexBufferSortKey() const
{
	return m_vertexBuffer->getSortKey();
}
