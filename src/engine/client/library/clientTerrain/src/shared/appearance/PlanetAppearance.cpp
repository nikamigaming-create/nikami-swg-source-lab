...
uintptr_t PlanetAppearance::LocalShaderPrimitive::getVertexBufferSortKey() const
{
...
uintptr_t PlanetAppearance::LocalShaderPrimitiveHalo::getVertexBufferSortKey() const
{
	return m_vertexBuffer.getSortKey ();
}
