...
namespace SetupClientGameNamespace
{
	...
	void writeStartupTrace(char const *stage)
	{
		...
		fprintf(file, "SetupClientGame:%s\n", stage);
		fclose(file);
	}
...
void SetupClientGame::install (const Data &data)
{
	...
	writeStartupTrace("after-ui-text-style-manager");
	...
	writeStartupTrace("after-localization-debug-display");

	ClientObject::install (data.m_viewer);
	writeStartupTrace("after-client-object");

	PortalProperty::install(beginCreateClientCellObject, endCreateClientCellObject);
	writeStartupTrace("after-portal-property");

	{
		...
		writeStartupTrace("after-shared-collision");
	}
	...
	writeStartupTrace("after-cell-property-hooks");

	ClientObjectTemplate::install(true);
	writeStartupTrace("after-client-object-template");
	ClientCellObjectTemplate::install();
	writeStartupTrace("after-client-cell-object-template");
	ClientCollisionProperty::install();
	writeStartupTrace("after-client-collision-property");
	...
	writeStartupTrace("after-client-game-appearance-events");
	LightsaberAppearanceTemplate::install ();
	writeStartupTrace("after-lightsaber-appearance-template");
	LightsaberAppearance::install ();
	writeStartupTrace("after-lightsaber-appearance");

	LightsaberCollisionManager::install ();
	writeStartupTrace("after-lightsaber-collision-manager");

	PostProcessingEffectsManager::install();
	writeStartupTrace("after-post-processing-effects-manager");
	Bloom::install ();
	writeStartupTrace("after-bloom");
	...
	if (!data.m_viewer)
	{
		...
		writeStartupTrace("after-callback-hooks");
		...
		writeStartupTrace("after-saddle-manager");

		//-- objects
		TangibleObject::install ();
		writeStartupTrace("after-tangible-object");
		CreatureObject::install();
		writeStartupTrace("after-creature-object");
		CreatureController::install ();
		writeStartupTrace("after-creature-controller");
		RemoteCreatureController::install ();
		writeStartupTrace("after-remote-creature-controller");
		PlayerCreatureController::install ();
		writeStartupTrace("after-player-creature-controller");
		GameAnimationMessageCallback::install ();
		writeStartupTrace("after-game-animation-message-callback");
		ClientStructureFootprintObject::install ();
		writeStartupTrace("after-client-structure-footprint-object");
		...
		writeStartupTrace("after-dynamic-debris-object");
		WanderController::install ();
		ClientNoBuildNotification::install ();
		TurretObject::install ();
		writeStartupTrace("after-turret-object");
		...
		writeStartupTrace("after-ship-objects");
		...
		writeStartupTrace("after-client-tangible-object-template");
		ClientUniverseObjectTemplate::install();
		ClientVehicleObjectTemplate::install();
		ClientWaypointObjectTemplate::install();
		writeStartupTrace("before-client-weapon-object-template");
		ClientWeaponObjectTemplate::install();
		writeStartupTrace("after-client-weapon-object-template");
		...
		writeStartupTrace("after-game-playback-script");

		//-- ClientEffect system
		ClientEffectTemplateList::install();
		writeStartupTrace("after-client-effect-template-list");
		ClientEffectManager::install();
		writeStartupTrace("after-client-effect-manager");
		ClientEventManager::install();
		writeStartupTrace("after-client-event-manager");
		PositionClientEffect::install();
		writeStartupTrace("after-position-client-effect");
		ObjectClientEffect::install();
		writeStartupTrace("after-client-effect-system");

		GroundCombatActionManager::install();
		writeStartupTrace("after-ground-combat-action-manager");

		ClientSecureTradeManager::install();
		writeStartupTrace("after-client-secure-trade-manager");
		PlayerMusicManager::install();
		writeStartupTrace("after-player-music-manager");
		MatchMakingManager::install();
		writeStartupTrace("after-match-making-manager");
		CustomerServiceManager::install();
		writeStartupTrace("after-customer-service-manager");
		AlarmManager::install();
		writeStartupTrace("after-alarm-manager");
		ChatLogManager::install();
		writeStartupTrace("after-chat-log-manager");
		ClientTextManager::install();
		writeStartupTrace("after-client-text-manager");
		CommunityManager::install();
		writeStartupTrace("after-community-manager");
		CombatSpecialMoveVisualData::install ("combat/special_move_visuals.iff");
		writeStartupTrace("after-combat-special-move-visual-data");
		GameNetworkConnection::install();
		writeStartupTrace("after-game-network-connection");
		AwayFromKeyBoardManager::install();
		writeStartupTrace("after-away-from-keyboard-manager");
		InputActivityManager::install();
		writeStartupTrace("after-input-activity-manager");
		writeStartupTrace("after-common-managers");
		...
		writeStartupTrace("after-world-systems");
		...
		writeStartupTrace("after-combat-effects-manager");
		...
		writeStartupTrace("after-expertise-managers");

		WeaponObject::install();
		writeStartupTrace("after-weapon-object");
	}
