...
public:
	...
	static void                          setVrTvModeEnabled(bool enabled);
	...
	static bool                          vrIsWorldRenderingEnabled();
	static bool                          vrBeginWorldFrame();
	static bool                          vrGetEyeInfo(int eye, Gl_vrEyeInfo &eyeInfo);
	static bool                          vrBeginEye(int eye);
	static void                          vrEndEye(int eye);
	static void                          vrEndWorldFrame();
	static void                          vrEndWorldFrameWithMenuQuad();
	static bool                          vrBeginHudCapture();
	static bool                          vrBeginHudCapture(int *width, int *height);
	static void                          vrEndHudCapture();
	static bool                          vrBeginWristDashboardCapture(int *width, int *height);
	static void                          vrEndWristDashboardCapture();
	static void                          vrSubmitHudPanelRect(char const *panelName, int left, int top, int right, int bottom, int sourceWidth, int sourceHeight);
	static void                          vrSubmitHudPanelAnchor(char const *panelName, float x, float y, float z, float radius, bool valid);
	static void                          vrSubmitObjectContextInputRegion(int slot, int textureLeft, int textureTop, int textureRight, int textureBottom, int clientLeft, int clientTop, int clientRight, int clientBottom, bool active);
	static void                          vrSubmitObjectContext(char const *targetName, int health, int healthMax, int action, int actionMax, int mind, int mindMax, bool attackable);
	static void                          vrSubmitHoverTargetContext(char const *targetName, int health, int healthMax, int action, int actionMax, int mind, int mindMax, bool attackable);
	static void                          vrSubmitWristDashboard(float playerX, float playerZ, float headingRadians, int health, int healthMax, int action, int actionMax, int mind, int mindMax, bool valid);
