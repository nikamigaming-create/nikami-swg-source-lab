...
class ShaderEffect
{
	...
	friend class VulkanStaticShaderData;
...
inline uintptr_t ShaderEffect::getShaderImplementationSortKey() const
{
	return reinterpret_cast<uintptr_t>(m_implementation);
}
