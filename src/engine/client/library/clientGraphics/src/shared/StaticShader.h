...
public:
	...
	virtual uintptr_t getTextureSortKey() const = 0;
};
...
public:
	...
	uintptr_t                   getShaderTemplateSortKey() const;
	uintptr_t                   getShaderImplementationSortKey() const;
	uintptr_t                   getTextureSortKey() const;
...
private:
	...
	mutable uintptr_t                                    m_textureSortKey;
	const uintptr_t                                      m_shaderImplementationSortKey;
