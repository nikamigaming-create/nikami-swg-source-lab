...
uintptr_t StaticShader::getTextureSortKey() const
{
...
uintptr_t StaticShader::getShaderTemplateSortKey() const
{
	return reinterpret_cast<uintptr_t>(&getStaticShaderTemplate());
}

// ----------------------------------------------------------------------

uintptr_t StaticShader::getShaderImplementationSortKey() const
{
